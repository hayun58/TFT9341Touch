...
void tft9341::pushColor(uint16_t color) {
	digitalWrite(_dc, HIGH);
	digitalWrite(_cs, LOW);
...
void tft9341::setAddrWindow(int16_t x0, int16_t x1, int16_t y0, int16_t y1){
	sector( x0, x1,  y0, y1);	
}

// Draw a character
void tft9341::putChar(uint8_t c){
	int8_t i,j;
	uint8_t line;
...
void tft9341::print (uint16_t x,uint16_t y,char *str,uint16_t fontSize, uint16_t fColor){
	setCursor(x,y);
...
void tft9341::print (uint16_t x,uint16_t y,char *str,uint16_t fontSize, uint16_t fColor,uint16_t bColor){
	setCursor(x,y);
	setTextSize(fontSize);
...
void tft9341::print (uint16_t x,uint16_t y,String txtMsg,uint16_t fontSize, uint16_t fColor){
	setCursor(x,y);
	setTextSize(fontSize);
	setTextColor(fColor);
	print (txtMsg);
...
void tft9341::print (uint16_t x,uint16_t y,String txtMsg,uint16_t fontSize, uint16_t fColor,uint16_t bColor){
	setCursor(x,y);
	setTextSize(fontSize);
	setTextColor(fColor,bColor);
	print (txtMsg);
...
void tft9341::drawPixel (int16_t x, int16_t y,uint16_t color){
	sector(x,x,y,y);
	_SPIF=0;
...
void tft9341::drawHLine (int16_t x, int16_t y, int16_t w,uint16_t color){
	sector(x,x+w-1,y,y);
	digitalWrite(_dc, HIGH);
	digitalWrite(_cs, LOW);
...
void tft9341::drawFastHLine (int16_t x, int16_t y, int16_t w,uint16_t color){
	drawHLine ( x,  y,  w, color);	
}


void tft9341::drawVLine (int16_t x, int16_t y, int16_t h,uint16_t color){
	sector(x,x,y,y+h-1);
	_SPIF=0;
	digitalWrite(_dc, HIGH);
	digitalWrite(_cs, LOW);
...
void tft9341::drawFastVLine (int16_t x, int16_t y, int16_t h,uint16_t color){
	drawVLine ( x,  y,  h,color);	
}

void tft9341::drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1,uint16_t color) {
...
void tft9341::drawLinePolar (int16_t x0, int16_t y0, int16_t r, int16_t angle,uint16_t color){
	float x,y;
	uint16_t x1;
	uint16_t y1;
...
void tft9341::drawRect ( int16_t x, int16_t y, int16_t w, int16_t h,uint16_t color) {
	drawHLine(x,y,w,color);
...
// Draw a triangle
void tft9341::drawTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2,uint16_t color) {
	drawLine(x0, y0, x1, y1,color);
	drawLine(x1, y1, x2, y2,color);
	drawLine(x2, y2, x0, y0,color);
}

void tft9341::drawCircle(int16_t x0, int16_t y0, int16_t r,uint16_t color) {
	int16_t f = 1 - r;
	int16_t ddF_x = 1;
	int16_t ddF_y = -2 * r;
	int16_t x = 0;
...
void tft9341::drawCircleHelper( int16_t x0, int16_t y0, int16_t r, int8_t cornername,uint16_t color) {
	int16_t f     = 1 - r;
	int16_t ddF_x = 1;
	int16_t ddF_y = -2 * r;
	int16_t x     = 0;
...
void tft9341::drawRoundRect(int16_t x, int16_t y, int16_t w,int16_t h, int16_t r,uint16_t color) {
	// smarter version
...
void tft9341::fillRect(int16_t x, int16_t y, int16_t w, int16_t h,uint16_t color){
	SPI.setClockDivider(SPI_CLOCK_DIV2);
...
// Fill a triangle
void tft9341::fillTriangle ( int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2,uint16_t color){
	int16_t a, b, y, last;
...
void tft9341::fillCircle(int16_t x0, int16_t y0, int16_t r,uint16_t color){
	drawVLine(x0, y0-r, 2*r+1,color);
	fillCircleHelper(x0, y0, r, 3, 0,color);
}

void tft9341::fillCircleHelper(int16_t x0, int16_t y0, int16_t r,uint8_t cornername, int16_t delta,uint16_t color){
	int16_t f     = 1 - r;
	int16_t ddF_x = 1;
	int16_t ddF_y = -2 * r;
	int16_t x     = 0;
...
void tft9341::fillRoundRect(int16_t x, int16_t y, int16_t w, int16_t h, int16_t r,uint16_t color) {
	// smarter version
...
uint16_t tft9341::color565(uint8_t r, uint8_t g, uint8_t b) {
...
uint16_t tft9341::ADS_Read_AD(uint16_t CMD){
	uint8_t data1, data2;
	uint16_t dx;
...
uint16_t tft9341::getToucX(){
	return(ADS_Read_AD(0xD0));
}

uint16_t tft9341::getToucY(){
	return (ADS_Read_AD(0x90));
}



void tft9341::readTouch(){
...
void tft9341::set(uint16_t xs1, uint16_t xs2, uint16_t ys1, uint16_t ys2){
